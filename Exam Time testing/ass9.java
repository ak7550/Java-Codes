...
class Dept
{
    ...
    void showAll()
    {
        System.out.println("\nAll the working empployyes details are: ");
        System.out.println("============================================");
...
class ass9
{
  ...
  {
    Dept d=new Dept("Information Technology", "Jadavpur University", 5);
    int exp=0;
    for (int i = 0; i < d.no_of_emp; i++)
        exp+=d.emp[i].salary;
    d.showAll();
    System.out.println("\nTotal monthly expenditure of "+d.name+" "+d.location+" is: "+exp+"\nTotal annual expenditure is: "+exp*12);
  }
}